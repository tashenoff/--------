            ...
            <div className="bg-gradient-to-r from-primary-100 to-accent-100 rounded-xl p-6 border border-primary-200">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="bg-whatsapp-500 hover:bg-whatsapp-600 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 text-sm"
                >
