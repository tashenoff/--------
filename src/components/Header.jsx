        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-lg lg:text-base font-heading font-bold text-gray-900 truncate">
                {data.company.name}
              </h1>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
                <button 
                  ...
                  className="bg-whatsapp-500 hover:bg-whatsapp-600 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-1 sm:space-x-2 px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base"
                >
