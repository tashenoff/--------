          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="text-gray-300 space-y-4 text-lg leading-relaxed">
              <p>
                ...
                от завода производителя на склад компании, без посредников.
              </p>
              <p>
                Ознакомиться с ценами, фотографиями и характеристиками задвижек можно прямо на сайте. 
                Для уточнения деталей можно звонить по телефонам, указанным в разделе контакты. 
                Мы работаем по предоплате 100% или 50% с отсрочкой платежа до договору. 
                Максимально быстрый сбор товара на складе, бесплатная доставка по городу, 
                платная доставка во все регионы Казахстана в короткие сроки.
              </p>
            </div>
          </div>
        </div>
